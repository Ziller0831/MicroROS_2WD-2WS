...
void setup()
{
  ...
  encoders[0].setPeerPcntDistance(1);
  encoders[1].setPeerPcntDistance(1);

  encoders[0].setGlitchFilter(0.5);
  encoders[1].setGlitchFilter(0.5);
}
...
void loop()
{
  ...
  Serial.printf("R: Speed:%d, L Speed:%d\n", encoders[0].getSpeed(), encoders[1].getSpeed());
  delay(10);
}
