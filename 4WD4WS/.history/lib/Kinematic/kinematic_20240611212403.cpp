...
Kinematics::Kinematics(base robot_base, int motor_max_vel,
                       ...
                       float track) : eBasePlatform_(robot_base),
                                      iMaxVel_(motor_max_vel * (60 / fWheelCircumference_) / 1000),
...
Kinematics::CP Kinematics::baseOrderConvert(MControl *mControl)
{
    ...
    converterParameters.pwm.BLDC_R = mControl->rpm.BLDC_R * (1025 / (iMaxVel_ * (60 / fWheelCircumference_) / 1000));
    converterParameters.pwm.BLDC_L = mControl->rpm.BLDC_L * (1025 / (iMaxVel_ * (60 / fWheelCircumference_) / 1000));
