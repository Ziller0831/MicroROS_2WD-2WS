...
Kinematics::MControl Kinematics::ackerman(MCommand *mCommand)
{
    ...
    {
        mControl.rpm.BLDC_L = constrain((linear_x_mm / 1000), iMaxVel_, -iMaxVel_) * (60 / fWheelCircumference_);
        mControl.rpm.BLDC_R = constrain((linear_x_mm / 1000), iMaxVel_, -iMaxVel_) * (60 / fWheelCircumference_);
