...
public:
    ...
    first_trans_parm inverseKinematics(float linear_x, float rotate_z);
...
private:
    ...
    first_trans_parm ackermann(float linear_x, float steer_angle);
    first_trans_parm selfRotate(float rotate_vel);
};
