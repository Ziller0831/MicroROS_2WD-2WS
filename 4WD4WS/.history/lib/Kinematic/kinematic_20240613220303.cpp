...
Kinematics::CP Kinematics::baseOrderConvert(MControl *mControl)
{
    ...
    converterParameters.pwm.BLDC_R = mControl->rpm.BLDC_R * (1025 / _iMaxRPM);
    converterParameters.pwm.BLDC_L = mControl->rpm.BLDC_L * (1025 / _iMaxRPM);
