...
Kinematics::MControl Kinematics::ackerman(MCommand *mCommand)
{
    ...
    if (center_rotation_rad > 800 && turning_angle > 0)
    {
        ...
        vel_L = (R_long / cos(angle_L)) / abs_center_rotation_rad * linear_x_mins;
    }
    else if (center_rotation_rad < -800 && turning_angle > 0)
    {
        ...
        vel_R = (R_long / cos(angle_R)) / abs_center_rotation_rad * linear_x_mins;
        vel_L = (R_short / cos(angle_L)) / abs_center_rotation_rad * linear_x_mins;
    }
    else
    {
        angle_R = 0;
