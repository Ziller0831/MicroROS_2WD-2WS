...
class BLDC : public MotorInterface
{
    ...
    public:
        //* 物件建構子多載 
        BLDC(bool inverint pwm_pin, int pwm_channel, int rev_pin, int pwm_offset): pwm_pin_(pwm_pin), pwm_channel_(pwm_channel), rev_pin_(rev_pin), pwm_offset_(pwm_offset)
        {
