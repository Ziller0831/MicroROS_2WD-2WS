...
void setup()
{
  ...
  // R_Stepper.setAcceleration(7600 / 4);
  // R_Stepper.setSpeed(7600);

  // L_Stepper.setMaxSpeed(7600 * 1.5);
  // R_Stepper.setAcceleration(7600 / 4);
  // L_Stepper.setSpeed(7600);

  R_Stepper.setMaxSpeed(5000); //* pulse
  R_Stepper.setAcceleration(1000);
  R_Stepper.setSpeed(3000);

  L_Stepper.setMaxSpeed(5000);
  R_Stepper.setAcceleration(1000);
  L_Stepper.setSpeed(3000);
