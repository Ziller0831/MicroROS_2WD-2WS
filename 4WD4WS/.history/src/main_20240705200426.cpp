...
BLDC bldcR_controller(false, BLDC_R_PWM, R_PWM_CHANNEL, BLDC_R_REV, 300, PWM_RESOLUTION);
BLDC bldcL_controller(false, BLDC_L_PWM, L_PWM_CHANNEL, BLDC_L_REV, 300, PWM_RESOLUTION);
...
void setup()
{
  ...
  R_Stepper.setAcceleration(500);
  R_Stepper.setSpeed(2500);

  L_Stepper.setMaxSpeed(16000);
  R_Stepper.setAcceleration(500);
  L_Stepper.setSpeed(2500);
...
void moveBase()
{
  ...
  test_msg.data = req_convertPara.pwm.BLDC_L;
