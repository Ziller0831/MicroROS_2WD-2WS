...
void ROS_communication::vel_callback(const void *msg_recv)
{
    ...
    kinematics.MotionCommand.linear_x = received_data->linear_x;
    center_rotation_rad = received_data-> center_rotation_rad;
    turning_distance = received_data-> turning_distance;
