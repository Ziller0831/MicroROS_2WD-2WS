...
extern unsigned long long time_offset = 0;
const unsigned int control_timeout = 10; // 100hZ

extern unsigned long prev_cmd_time = 0;
...
extern BLDC bldcR_controller(false, BLDC_R_PWM, R_PWM_CHANNEL, BLDC_R_REV, 120);
extern BLDC bldcL_controller(false, BLDC_L_PWM, L_PWM_CHANNEL, BLDC_L_REV, 120);
