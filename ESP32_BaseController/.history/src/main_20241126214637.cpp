...
#include <FastAccelStepper.h> // 替換為 FastAccelStepper 函式庫
...
void moveBase()
{
  ...
  if (R_Stepper && L_Stepper)
  {
    ...
    {
      int32_t right_steps = req_convertPara.pulse.STEPPER_R;
      int32_t right_steps = req_convertPara.pulse.STEPPER_L;
    }
    else
    {
      int32_t right_steps = req_convertPara.pulse.STEPPER_R - current_right_pos;
      int32_t left_steps = req_convertPara.pulse.STEPPER_L - current_left_pos;
    }
