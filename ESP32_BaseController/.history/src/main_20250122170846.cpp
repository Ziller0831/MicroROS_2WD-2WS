...
void moveBase(float linear_x = joy_command.linear_x, center_rotation_rad = 0, float center_rotation_angle = float joy_command.center_rotate_angle, int turning_mode = joy_command.turning_mode;)
{
  int32_t right_steps;
  int32_t left_steps;
